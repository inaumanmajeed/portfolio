...
import { blodData } from "../../utlits/fixedVariables/blogsData";
  ...
  return (
    <section id="blog" className="blog-area">
      <div className="container">
        ...
        <div className="row">
          {blodData.map(({ date, descripation, id, src, title }) => (
            <Card
              key={id}
              date={date}
              src={src}
      ...
      <ZoomIn id={id}>
        <div className="blog-item">
          ...
          <div className="content">
            ...
            <p>{descripation}</p>
            <hr />
            <div className="blog-Btn-adjustment">
            <a href="#" className="theme-btn">
              Read More
              <i>
                <RiBookReadLine size={15} />
              </i>
              </a>
              </div>
          </div>
